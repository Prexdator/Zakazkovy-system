...
<center><h1>Docházka malý sprinter</h1></center>
...
echo '<td>';
 ...
 $mysqli = new mysqli('a026um.forpsi.com', 'f123770', 'EWNnJ75', 'f123770');   
                        $mysqli1 = new mysqli('a026um.forpsi.com', 'f123772', 'Q3QPeKA', 'f123772');   
                            echo'<br>';
echo'<center><table width="80%" border="1"> <h2>Dnes Maly sprinter</h2> ';
 $sql1 = "SELECT id,cas FROM malysprinter WHERE datum='$datumdnes' ";
          $result1 = mysqli_query($mysqli1, $sql1);
                  while($row = mysqli_fetch_assoc($result1)) {
        $id1 = $row['id'];
                     $v = $row['cas'];
